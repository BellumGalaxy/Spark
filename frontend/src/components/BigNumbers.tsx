    ...
    <div className='bignumbers-wrap' ref={ref}>
      ...
      <div className='bignumbers-content-wrap'>
        <div className='bignumber-individual-wrap'>
          {isVisible && <CountUp className='number' start={0} end={753} duration={3} />}
          <p className='description'>Campanhas apoiadas</p>
        </div>
        <div className='bignumber-individual-wrap'>
          {isVisible && <CountUp className='number' start={0} end={456} duration={3} />}
          <p className='description'>Atletas patrocinados</p>
        </div>
        <div className='bignumber-individual-wrap'>
          {isVisible && <CountUp className='number' start={0} end={1346218.02} duration={3} prefix="R$ " separator="." decimal="," decimals={2} />}
